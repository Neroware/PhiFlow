...
def run_test_cases(test_cases):
    ...
    plot_grid_diff_y_mirror(u1_init, u2_init, RESOLUTION[0] + 1, RESOLUTION[0], "diff_init.jpg")
    ...
    plot_grid_diff_y_mirror(u1_1, u2_1, RESOLUTION[0] + 1, RESOLUTION[0], "diff_1.jpg")
    ...
    for count in range(0, 6):
        ...
        plot_grid_diff_y_mirror(u1, u2, RESOLUTION[0] + 1, RESOLUTION[0], "diff_" + ((count + 1) * 50) + ".jpg")
